        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed text-base md:text-lg mb-6">
              I approach software engineering with a strong focus on algorithmic logic and structural precision. As a LeetCode Knight and Codeforces Specialist with over 950+ coding problems, I believe that high-performance code starts with optimal data structures and clean, mathematical reasoning. Whether I am building secure, chunked file-streaming systems or orchestrating TypeScript-based monorepos, I aim for structural excellence at every level of the stack.
            </p>
